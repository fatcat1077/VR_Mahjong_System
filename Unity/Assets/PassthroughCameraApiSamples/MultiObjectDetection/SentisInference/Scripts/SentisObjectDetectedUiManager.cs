...
namespace PassthroughCameraSamples.MultiObjectDetection
{
    ...
    public class SentisObjectDetectedUiManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// True if the detection canvas GameObject is currently active.
        /// </summary>
        public bool IsCanvasVisible => m_detectionCanvas != null && m_detectionCanvas.activeSelf;

        /// <summary>
        /// Show/hide the detection canvas.
        /// Useful when you want to temporarily disable drawing boxes and only show a prompt panel.
        /// </summary>
        public void SetCanvasVisible(bool visible)
        {
            if (m_detectionCanvas != null)
            {
                m_detectionCanvas.SetActive(visible);
            }
        }
        ...
        {
            if (m_detectionCanvas == null || !m_detectionCanvas.activeInHierarchy)
            {
                return;
            }
